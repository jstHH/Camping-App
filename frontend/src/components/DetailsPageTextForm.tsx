...
export default function DetailsPageTextForm({title, setTitle, description, setDescription, startlocation, setStartLocation, forCar, trailer}: DetailsPageTextFormProps) {
    return <div>
        <Form>
            <Form.Group>
