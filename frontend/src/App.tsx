...
function App() {
    ...
    const {carItems, addCarItem, updateCarItem} = useCarItems()
    ...
    <div className="App">
        ...
        <Routes>
            <Route element={<RequireAuth />}>
                ...
                <Route path={`/campsite/car/:id`} element={<CarDetailsPage appUsers={appUsers} currentUser={currentUser} updateCarItem={updateCarItem}/>}/>
            </Route>
